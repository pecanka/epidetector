...
!           PRINT *,"cdf_finalize_status: ", status !! Jakub
        END IF
...
! ..
        ...
        !! Make sure status starts with a zero value
        chisq_status = 0
...
! DMS dg = df + 2*icent, could be > upper bound for the Chi-squared df
        ...
        !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
!         pcent = zero                           !!!! added by Jakub
!         ccum = one                             !!!! added by Jakub
!         x = 25.01334257_dpkind
!         print *,"==========================" !!!! added by Jakub
!         print *,"pcent=", pcent              !!!! added by Jakub
!         print *,"ccum=", ccum                !!!! added by Jakub
!         print *,"x=", x                      !!!! added by Jakub
!         print *,"df0=", df0                   !!!! added by Jakub
!         !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
!         print *,"chisq_status=", chisq_status   !!!! added by Jakub
!         !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
